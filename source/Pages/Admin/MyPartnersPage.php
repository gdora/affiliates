 ...
 * Time: 6:08:48 PM
 */
class WPAM_Pages_Admin_MyPartnersPage extends WPAM_Pages_Admin_AdminPage {
    ...
    public function processRequest($request) {
        ...
        if (isset($request['viewDetail']) && is_numeric($request['viewDetail'])) {
            ...
            $response = new WPAM_Pages_TemplateResponse('admin/partners_list');
        }
        return $response;
    }
    ...
    protected function getDetailForm($affiliateFields, $model, $request = null, $validationResult = null) {
        ...
        $accountStanding = $db->getTransactionRepository()->getAccountSummary($model->affiliateId, $model->bountyAmount);
print_r($accountStanding);
